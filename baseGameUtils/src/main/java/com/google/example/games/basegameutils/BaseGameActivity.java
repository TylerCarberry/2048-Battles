...
public abstract class BaseGameActivity extends FragmentActivity implements
    ...
    private final static String DENIED_LOGIN_KEY = "DENIED_LOGIN";
    private static boolean deniedSignIn = false;
    ...
    protected void onStart() {
        ...
        boolean deniedSignIn = getSharedPreferences(SHARED_PREFS, 0).getBoolean(DENIED_LOGIN_KEY, false);
        mHelper.setConnectOnStart(! deniedSignIn);
    ...
    public void setDeniedSignIn(boolean setDenied) {
    	deniedSignIn = setDenied;
    	mHelper.setConnectOnStart(! deniedSignIn);
    }
}
