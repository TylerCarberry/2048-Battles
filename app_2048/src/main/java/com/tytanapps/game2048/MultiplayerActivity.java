...
public class MultiplayerActivity extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    void updateRoom(Room room) {
        ...
        //Toast.makeText(this, "In update room, num participants = " + (mParticipants.size()), Toast.LENGTH_SHORT).show();
    ...
    void sendMessage(String message, boolean reliable) {
        ...
        for (Participant p : mParticipants) {
            ...
            Log.d(TAG, "This will be printed for every participant receiving the message");
